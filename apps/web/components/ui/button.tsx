...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 cursor-pointer items-center justify-center border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default:
          "rounded-full bg-hub-cta text-white shadow-[var(--shadow-hub-cta)] hover:opacity-90 [a]:hover:opacity-90",
        outline:
          "rounded-full border-[var(--odos-input-border)] bg-white text-hub-heading hover:bg-[var(--odos-input-bg-subtle)] aria-expanded:bg-muted aria-expanded:text-foreground",
        secondary:
        ...
        ghost:
          "rounded-lg hover:bg-hub-selected/50 hover:text-hub-heading aria-expanded:bg-muted aria-expanded:text-foreground",
        destructive:
        ...
        navy:
          "rounded-full bg-hub-navy text-white hover:opacity-90",
        auth:
          "rounded-full bg-auth-cta text-white hover:opacity-90",
      },
      size: {
        default:
